    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-10 pt-16 text-center sm:pt-24">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-ink/70">
          Julius&apos;s core, in production: upload a dataset, ask in plain English, and get back a chart, a
      ...
      <section className="mx-auto max-w-5xl px-6 py-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Feature n="3" title="The part Julius doesn't ship" accent="#34e0c0">
            An MCP server exposes the whole platform, so any agent can pilot it — upload, ask, and pull back the
            chart, table, and the generated code. Julius is an MCP client with no public API; this fills that gap.
          </Feature>
