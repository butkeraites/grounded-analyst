...
const g = globalThis as unknown as { __juliusAnalytics?: Analytics };

export function getAnalytics(): Analytics {
  if (!g.__juliusAnalytics) g.__juliusAnalytics = new ObservabilitySink();
  return g.__juliusAnalytics;
}
