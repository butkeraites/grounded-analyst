...
const databaseUrl = process.env.DATABASE_URL ?? "postgres://grounded:grounded@localhost:5432/grounded";
const redisUrl = process.env.REDIS_URL ?? "redis://localhost:6379";
const image = process.env.SANDBOX_IMAGE ?? "grounded-sandbox:latest";
