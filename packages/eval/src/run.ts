...
import { createCoreServiceFromEnv, closeDb, type Artifact } from "@grounded/core";
...
process.env.DATABASE_URL ??= "postgres://grounded:grounded@localhost:5432/grounded";
process.env.SANDBOX_IMAGE ??= "grounded-sandbox:latest";
